...
const SEMANTIC_TOKENS = [
  { name: "--accent", role: "Accent/highlight color", hsl: "121 66% 42%", palette: "green-500" },
  { name: "--accent-foreground", role: "Text on accent", hsl: "0 0% 100%", palette: "white" },
  { name: "--background", role: "Page background", hsl: "0 0% 98%", palette: "gray-25" },
  { name: "--border", role: "Default borders", hsl: "220 5% 92%", palette: "gray-100" },
  { name: "--card", role: "Card background", hsl: "0 0% 100%", palette: "white" },
  { name: "--card-foreground", role: "Card text", hsl: "220 20% 12%", palette: "gray-900" },
  ...
  { name: "--foreground", role: "Primary text", hsl: "220 20% 12%", palette: "gray-900" },
  { name: "--input", role: "Input borders", hsl: "220 5% 92%", palette: "gray-100" },
  { name: "--muted", role: "Muted backgrounds", hsl: "0 0% 96%", palette: "gray-50" },
  { name: "--muted-foreground", role: "Secondary/subtle text", hsl: "224 5% 47%", palette: "gray-500" },
  { name: "--popover", role: "Popover background", hsl: "0 0% 100%", palette: "white" },
  { name: "--popover-foreground", role: "Popover text", hsl: "220 20% 12%", palette: "gray-900" },
  ...
  { name: "--secondary", role: "Secondary surfaces", hsl: "0 0% 96%", palette: "gray-50" },
  { name: "--secondary-foreground", role: "Text on secondary", hsl: "220 20% 12%", palette: "gray-900" },
  { name: "--success", role: "Success/positive", hsl: "121 66% 42%", palette: "green-500" },
