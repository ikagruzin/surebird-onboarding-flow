...
const SEMANTIC_TOKENS = [
  { name: "--accent", role: "Accent/highlight color", hsl: "121 66% 42%", palette: "Light Green 500" },
  { name: "--accent-foreground", role: "Text on accent", hsl: "0 0% 100%", palette: "White" },
  { name: "--background", role: "Page background", hsl: "0 0% 98%", palette: "Neutral 50" },
  { name: "--border", role: "Default borders", hsl: "220 5% 92%", palette: "Neutral 200" },
  { name: "--card", role: "Card background", hsl: "0 0% 100%", palette: "White" },
  { name: "--card-foreground", role: "Card text", hsl: "220 20% 12%", palette: "Neutral 900" },
  { name: "--destructive", role: "Error/danger", hsl: "4 86% 58%", palette: "Red 500" },
  { name: "--destructive-foreground", role: "Text on destructive", hsl: "0 0% 100%", palette: "White" },
  { name: "--foreground", role: "Primary text", hsl: "220 20% 12%", palette: "Neutral 900" },
  { name: "--input", role: "Input borders", hsl: "220 5% 92%", palette: "Neutral 200" },
  { name: "--muted", role: "Muted backgrounds", hsl: "0 0% 96%", palette: "Neutral 100" },
  { name: "--muted-foreground", role: "Secondary/subtle text", hsl: "224 5% 47%", palette: "Neutral 500" },
  { name: "--popover", role: "Popover background", hsl: "0 0% 100%", palette: "White" },
  { name: "--popover-foreground", role: "Popover text", hsl: "220 20% 12%", palette: "Neutral 900" },
  { name: "--primary", role: "Primary action (blue)", hsl: "209 100% 51%", palette: "Blue 500" },
  { name: "--primary-foreground", role: "Text on primary", hsl: "0 0% 100%", palette: "White" },
  { name: "--ring", role: "Focus ring", hsl: "209 100% 51%", palette: "Blue 500" },
  { name: "--secondary", role: "Secondary surfaces", hsl: "0 0% 96%", palette: "Neutral 100" },
  { name: "--secondary-foreground", role: "Text on secondary", hsl: "220 20% 12%", palette: "Neutral 900" },
  { name: "--success", role: "Success/positive", hsl: "121 66% 42%", palette: "Light Green 500" },
  { name: "--success-foreground", role: "Text on success", hsl: "0 0% 100%", palette: "White" },
];
