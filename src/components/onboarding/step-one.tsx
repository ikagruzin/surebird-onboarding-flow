...
const TRANSLATIONS = {
  en: {
    ...
    individualSubtitle: "Smartly insured: ",
    individualSubtitleAmount: "save up to €300",
    ...
    bundles: {
      ...
      "popular": { title: "Popular choice", description: "Our bundle of the most popular products: Home, Car and Liability." },
