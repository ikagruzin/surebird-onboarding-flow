...
import { ShoppingBag, Home, Briefcase, Car, KeyRound, TrendingUp, Scale, ChevronDown, ChevronUp, Check } from "lucide-react";
  ...
  return (
    <div className="space-y-3">
      {visibleOptions.map((opt) => {
        ...
        const Icon = opt.icon;
        const isLocked = opt.id === "consumer";
